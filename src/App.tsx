...
function App() {
  ...
  return (
    <div className="pt-2">
      {/* desktop version */}
      <div className="w-full h-screen hidden lg:flex flex-col justify-center items-center relative">
        ...
        <button
          className="bg-[#4663AC] hover:bg-blue-950 text-white px-16 py-2 rounded-full cursor-pointer transition-all duration-300 mt-4"
      ...
      {/* mobile-version */}
      <div className="w-full h-screen relative flex lg:hide flex-col items-center justify-center">
